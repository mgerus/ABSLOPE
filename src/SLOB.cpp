...
// [[Rcpp::export]]
List ABSLOPE_approx(NumericVector start, arma::mat Xmis, arma::vec Y, double a_prior, double b_prior, double sigma = 1.0,
	...
	arma::vec beta_arma = as<arma::vec>(beta);
